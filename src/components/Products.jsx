...
export const Products = () => {
    ...
    <>
      <Link to='/'>
        <button style={{marginLeft:"5%"}} className="btn btn-dark">Logout</button>
      </Link>
      <Link to='/checkout'>
        <button style={{float:"right", marginRight:"5%"}}  className="btn btn-success">To Checkout</button>
      </Link>
                ...
                <tbody>
                    {state.map((item) => (
                        <tr key={item.id}>
                            ...
                            <td style={{width:'10%'}}>
                                <button className='btnchg min' onClick={() =>decrement(item.id)}>-</button>
                                {item.quantity}
                                <button className='btnchg max' onClick={() =>increment(item.id)}>+</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
